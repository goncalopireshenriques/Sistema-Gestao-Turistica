...
<head>
	...
	<title>Sistema de Gestão Turística - Comentários Associados</title>
											...
											<table class="table table-striped">
												...
												while($row = mysqli_fetch_array($query))
												{
													...
													echo "<td align='center'>" .$row2['Username']. "</td>";
													 //username do oeprador que respondeu ao comentario
													...
													if($perfil == 0)
													{
														if(empty($row2['0']))
														{
															echo "<td align='center'><a href='resposta.php?id=$id_comentario&categoria=$categoria&id_pdi=$id_pdi&tipo=$tipo' class='btn btn-outline-success btn-sm'><i class='fa fa-comment-alt'></i></a></td>";
														}
														else
														{
															echo "<td></td>";
													...
													{
														echo "<td align='center'><a href='resposta.php?id=$id_comentario&categoria=$categoria&id_pdi=$id_pdi&tipo=$tipo' class='btn btn-outline-success btn-sm'><i class='fa fa-comment-alt'></i></a></td>";
														echo	"<td align='center'><a href='./admin/remover_comentario.php?id=$id_comentario&tipo=$tipo' class='btn btn-outline-danger btn-sm'><i class='fa fa-times'></i></a></td>";
													}
