						...
						if (isset($_SESSION['username']) && $_SESSION['perfil'] == '1' || $_SESSION['perfil'] == '0' )
						{
							...
							{	
								...
								<div class="alert alert-success p-5" align="center">
									<font color="#444" size="6">Atração Turística editada com sucesso!</font>
									<?php
							...
							else
							{
								...
								<div class="alert alert-danger p-5" align="center">
									<font color="#444" size="6">Erro ao editar Atração Turística!</font>
									<?php
									header("refresh:2;url=editar_atracoes.php?id_pdi=$id_pdi");
									?>
								</div>
								<?php
							}
