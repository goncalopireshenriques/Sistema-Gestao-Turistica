...
<head>
	...
	<title>Sistema de Gestão Turística - Remover Acessibilidade</title>
			...
			<div class="col-md-12">
				<div class="card bg-dark">
					<div class="card-body">
						...
						{
							$id = $_GET['id'];
							$delete = "DELETE FROM acessibilidade WHERE ID_Acessibilidade='$id'";
							...
							<div class="alert alert-success p-5" align="center">
								<font color="#444" size="6">Acessibilidade removida com sucesso!</font>
