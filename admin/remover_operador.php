...
<head>
	...
	<title>Sistema de Gestão Turística - Remover Operador Turístico</title>
				...
				<div class="col-md-12">
					<div class="card bg-dark">
						<div class="card-body">
							...
							{
								$operador = $_GET['username'];
								$delete = "DELETE FROM operadorturistico WHERE Username='$operador'";
								if(mysqli_query($conn_bd, $delete))
								{
									...
									<div class="alert alert-success p-5" align="center">
										<font color="#444" size="6">Operador Turístico removido com sucesso!</font>
								...
								else
								{
									...
									<div class="alert alert-danger p-5" align="center">
										<font color="#444" size="6">Erro ao remover Operador Turístico!</font>
