...
<head>
	...
	<title>Sistema de Gestão Turística - Remover Atração Turística</title>
					...
					<div class="card bg-dark">
						<div class="card-body">
							...
							if(isset($_SESSION['username']) && $_SESSION['perfil'] == '1')
							{
								...
								if(mysqli_query($conn_bd, $delete)) // apaga o ponte de interesse correspondente a atracao escolhida
								{ 
									?>
								...
								else
								{
									...
									<div class="alert alert-danger p-5" align="center">
										<font color="#444" size="6">Erro ao remover Atração Turística!</font>

										<?php
										header("refresh:2;url=../gerir_atracoes.php");
										?>
