...
<head>
	...
	<title>Sistema de Gestão Turística - Adicionar Tipo de Ponto de Interesse</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-5">
						<form class="card" method="POST" action="processa_adicionar_tipo_pdi.php">
							<div class="card-header bg-secondary">
								<b>Formulário de Adição de Tipo de Ponto de Interesse</b>
							</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input name="nome" id="nome" class="form-control" placeholder="Introduza Nome">
										</div>
									</div>				
								</div>
							</div>
