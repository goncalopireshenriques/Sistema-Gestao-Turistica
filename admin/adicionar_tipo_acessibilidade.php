...
<head>
	...
	<title>Sistema de Gestão Turística - Adicionar Tipo de Acessibilidade</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-5">
						<form class="card" method="POST" action="processa_adicionar_tipo_acessibilidade.php">
							<div class="card-header bg-secondary">
								<b>Novo Tipo de Acessibilidade</b>
							</div>
