...
<head>
	...
	<title>Sistema de Gestão Turística - Registar Operador Turístico</title>
	...
	<div class="page-wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a href="../gerir_perfil" class="dropdown-item">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12" >
						<form class="card"  method="POST" action="processa_registar_operador.php">
							<div class="card-header bg-secondary">
								<b>Formulário de Registo de Operador Turístico</b>
							</div>
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="nome" required id="nome" type="text" class="form-control" placeholder="Introduza Nome">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="username" required id="username" type="text" class="form-control" placeholder="Introduza Username">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="password" required id="password" type="password" class="form-control" placeholder="Introduza Password">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="email" required id="email" type="email" class="form-control" placeholder="Introduza Email">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="contacto" required id="contacto" type="number" min="0" class="form-control" placeholder="Introduza Contacto">
										</div>
									</div>

								</div>
							</div>
							<button type="submit" name="submit" class="btn btn-block btn-outline-secondary btn-sm"><b>Registar</b></button>
						</form>
					</div>
				</div>
			</div>
