...
<head>
	...
	<title>Sistema de Gestão Turística - Gerir Tipo de Ponto de Interesse</title>
					...
					<ul class="nav">
						...
						<li class="nav-item nav-dropdown">
							...
							<ul class="nav-dropdown-items">
								...
								<li class="nav-item">
									<a href="gerir_tipo_pdi.php" class="nav-link active">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header bg-secondary">
								...
								<b>Tipos de Ponto de Interesse</b>

								<div class="card-actions">

									<a href="gerir_tipo_pdi.php" class="btn">
										<i class="fa fa-retweet"></i> &nbsp;
									</a>

									<a>
										<form action="gerir_tipo_pdi.php" method="post">
									...
									<a href="adicionar_tipo_pdi.php" class="btn"> 
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										if(isset($_POST['pesquisa']))
										{
											...
											$query = "SELECT ID_TipoPDI, Nome FROM tipopdi WHERE CONCAT(ID_TipoPDI, Nome) LIKE '%".$valorParaPesquisar."%'";
											$resultado_pesquisa = mysqli_query($conn_bd, $query);
										}
										else
										{
											$query = "SELECT ID_TipoPDI, Nome FROM tipopdi";
											$resultado_pesquisa = mysqli_query($conn_bd, $query);
										}
										
										while($row = mysqli_fetch_array($resultado_pesquisa)){
											echo "<tr>";
											echo "<td align='center'>" .$row['ID_TipoPDI']. "</p></td>";
											echo "<td align='center'>" .$row['Nome']. "</p></td>";
											$id = $row['ID_TipoPDI'];
											echo	"<td align='center'><a href='remover_tipo_pdi.php?id=$id' class='btn btn-outline-danger btn-sm'><i class='fa fa-times'></i></a></p></td>";
										}
										?>
									</table>
								</div>
