...
<head>
	...
	<title>Sistema de Gestão Turística - Remover Tipo de  Acessibilidade</title>
			...
			<div class="col-md-12">
				<div class="card bg-dark">
					<div class="card-body">
						...
						{
							$id = $_GET['id'];
							$delete = "DELETE FROM tipo_acessibilidade WHERE ID_Tipo_Acessibilidade='$id'";
							...
							<div class="alert alert-success p-5" align="center">
								<font color="#444" size="6">Tipo de Acessibilidade removido com sucesso!</font>
