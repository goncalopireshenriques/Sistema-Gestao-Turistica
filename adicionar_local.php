...
<head>
	...
	<title>Sistema de Gestão Turística - Adicionar Local</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12" >
						<form class="card"  method="POST" action="processa_adicionar_local.php" enctype="multipart/form-data">
							<div class="card-header bg-secondary">
								<b>Formulário de Adição de Local Turístico</b>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="file" accept="image/*" max="250" id="qr_code" name="qr_code" class="form-control" placeholder="Introduza QR Code">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<textarea name="precario" id="precario" type="text" class="form-control" rows="1" placeholder="Introduza Preços de Entrada"></textarea>
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="contacto" id="contacto" type="number" min="0" class="form-control" placeholder="Introduza Contacto">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input name="website" id="website" type="url" class="form-control" placeholder="Introduza Website">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<textarea name="horario" id="horario" type="text" class="form-control" rows="1" placeholder="Introduza Horário"></textarea>
										</div>
									</div>
									...
									<div class="col-md-12">
										...
										<div class="input-group mb-3">
											...
											<textarea name="descricao" id="descricao" class="form-control" rows="1" placeholder="Introduza a Descrição do Local"></textarea>
										</div>
									</div>
