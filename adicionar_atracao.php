...
<head>
	...
	<title>Sistema de Gestão Turística - Adicionar Atração Turística</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12" >
						<form class="card"  method="POST" action="processa_adicionar_atracao.php" enctype="multipart/form-data">
							<div class="card-header bg-secondary">
								<b>Formulário de Adição de Atração Turísrica</b>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="input-group mb-3">
											...
											<input type="file" accept="audio/*" max="250" id="audio" name="audio" class="form-control" placeholder="Introduza Audio">
										</div>
									</div>
									...
									<div class="col-md-6">
										...
										<div class="input-group mb-3">
											...
											<input type="file" accept="image/*" max="250" id="imagem" name="imagem" class="form-control" placeholder="Introduza Imagem">
										</div>
									</div>
									...
									<div class="col-md-4">
										<label for="single-select" class="require">Associar ao Local</label>
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="fa fa-tags"></i></span>
											</div>
											<?php
											$local="SELECT Nome FROM pdi WHERE Categoria = 1 ORDER BY Nome ASC";
											$query_local = mysqli_query($conn_bd, $local);
											$option = '';
											...
											?>
											<select name="local" required id="local" class="form-control">
												<?php echo $option; ?>
											</select>
										</div>
									</div>
