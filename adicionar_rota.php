...
<head>
	...
	<title>Sistema de Gestão Turística - Adicionar Rota Turística</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-10" >
						<form class="card"  method="POST" action="processa_adicionar_rota.php">
							<div class="card-header bg-secondary">
								<b>Formulário de Adição de Rota </b>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-2">
										...
										<div class="input-group mb-3">
											...
											<input type="time" name="duracao" required id="duracao" class="form-control" placeholder="Introduza Duração">
										</div>
									</div>
									...
									<div class="col-md-6">
										...
										<div class="input-group mb-3">
											...
											<?php
											$pdi="SELECT Nome FROM pdi ORDER BY Nome ASC";
									...
									<div class="col-md-6">
										...
										<div class="input-group mb-3">
											...
											<textarea name="ordem" required id="ordem" class="form-control" rows="3"></textarea>
										</div>
									</div>
