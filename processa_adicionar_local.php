...
<head>
	...
	<title>Sistema de Gestão Turística - Processa Adicionar Local Turístico</title>
				...
				<div class="card bg-dark">
					<div class="card-body">
						...
						if (isset($_SESSION['username']) && $_SESSION['perfil'] == '1' || $_SESSION['perfil'] == '0')
						{
							...
							VALUES ('$nome','$descricao', '$latitude', '$longitude', '$localizacao', '1', '$id_tipo')";

							if(mysqli_query($conn_bd, $insertPDI))
							{	
								$id_pdi = mysqli_insert_id($conn_bd);

								$insertLocal = "INSERT INTO local (Horario, Contacto, Website, Precario, ID_PDI) VALUES ('$horario', '$contacto', '$website', '$precario', '$id_pdi')";
								mysqli_query($conn_bd, $insertLocal);
								...
								<div class="alert alert-success p-5" align="center">
									<font color="#444" size="6">Local adicionado com sucesso!</font>
									<?php
							...
							else
							{
								...
								<div class="alert alert-danger p-5" align="center">
									<font color="#444" size="6">Erro ao adicionar Local!</font>
									<?php
									header("refresh:2;url=adicionar_local.php");
									?>
								</div>
								<?php
							}
