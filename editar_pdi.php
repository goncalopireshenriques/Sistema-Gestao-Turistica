...
<head>
	...
	<title>Sistema de Gestão Turística - Editar Ponto de Interesse</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
								...
								if($perfil==1)
								{
									...
									<li class="nav-item">
										<a href="./admin/gerir_tipo_acessibilidade.php" class="nav-link">
											<i class="fa fa-tags"></i> Tipos de Acessibilidades
										</a>
									</li>
									<?php
								}
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12" >
						<form class="card"  method="POST" action="processa_editar_pdi.php" enctype="multipart/form-data">
							<div class="card-header bg-secondary">
								<b>Formulário de Edição de Ponto de Interesse</b>
							</div>

							<?php
							$id_pdi = $_GET['id_pdi'];
							$select_pdi="SELECT Nome, Descricao, Latitude, Longitude, Localizacao, QR_Code, Audio, ID_Tipo_PDI FROM pdi WHERE ID_PDI='$id_pdi'";
							$pdi = mysqli_query($conn_bd, $select_pdi);
							list ($nome, $descricao, $latitude, $longitude, $localizacao, $qr_code, $audio, $id_tipo_pdi) = mysqli_fetch_row($pdi); 
							...
							<div class="card-body" >
								<div class="row">
									...
									<div class="col-md-4">
										<label for="required-input" class="form-control-label">Descrição Áudio</label>
										<div class="input-group mb-3">
											<div class="input-group-prepend">
