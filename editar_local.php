...
<head>
	...
	<title>Sistema de Gestão Turística - Editar Local Turístico</title>
	...
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12" >
						<form class="card"  method="POST" action="processa_editar_local.php" enctype="multipart/form-data">
							<div class="card-header bg-secondary">
								<b>Formulário de Edição de Local Turístico</b>
							</div>

							<?php
							$id_pdi = $_GET['id_pdi'];
							$select_local="SELECT p.Nome, p.Descricao, p.Latitude, p.Longitude, p.Localizacao, p.QR_Code, p.Audio, p.ID_Tipo_PDI, l.Horario, l.Contacto, l.Website, l.Precario FROM pdi AS p INNER JOIN local AS l ON l.ID_PDI=p.ID_PDI WHERE p.ID_PDI='$id_pdi'";
							$local = mysqli_query($conn_bd, $select_local);
							list ($nome, $descricao, $latitude, $longitude, $localizacao, $qr_code, $audio, $id_tipo_pdi, $horario, $contacto, $website, $precario) = mysqli_fetch_row($local); 
							?>
							...
							<div class="card-body" >
								...
								<div class="col-md-4">
									...
									<div class="col-md-4">
										<label for="textarea">Preçário</label>
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="fa fa-ticket-alt"></i></span>
											</div>
											<textarea name="precario" id="precario" type="text" class="form-control" rows="1" placeholder="Introduza Preços de Entrada" ><?php echo $precario;?></textarea>
										</div>
									</div>

									<div class="col-md-4">
										<label for="required-input" class="form-control-label">Contacto</label>
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="fa fa-phone"></i></span>
											</div>
											<input name="contacto" id="contacto" type="number" min="0" class="form-control" placeholder="Introduza Contacto" value="<?php echo $contacto;?>">
										</div>
									</div>

									<div class="col-md-4">
										<label for="required-input" class="form-control-label">Website</label>
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text"><b>@</b></span>
											</div>
											<input name="website" id="website" type="url" class="form-control" placeholder="Introduza Website" value="<?php echo $website;?>">
										</div>
									</div>

									<div class="col-md-4">
										<label for="textarea">Horário de Funcionamento</label>
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="fa fa-calendar"></i></span>
											</div>
											<textarea name="horario" id="horario" type="text" class="form-control" rows="1" placeholder="Introduza Horário"><?php echo $horario;?></textarea>
										</div>
									</div>
									...
									<div class="col-md-12">
										...
										<div class="input-group mb-3">
											...
											<textarea name="descricao" id="descricao" class="form-control" rows="1" placeholder="Introduza a Descrição do Local"><?php echo $descricao;?></textarea>
										</div>
									</div>
