...
<head>
	...
	<title>Sistema de Gestão Turística - Gerir Dados de Perfil</title>
...
<body class="sidebar-fixed header-fixed">
	<div class="page-wrapper">
		...
		<div class="main-container">
			...
			<div class="content">
				<div class="col-md-10" >
					<form class="card"  method="POST" action="processa_editar_perfil.php">
						...
						<div class="card-actions">
							...
							<a href="alterar_password.php" class="btn"> 
								<i class="fa fa-key"></i> &nbsp; <b>Alterar Password</b>
							</a>
						</div>

						<?php
						$select_perfil="SELECT Nome, Contacto, Password, Username, Email FROM operadorturistico WHERE Username='$utilizador'";
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="input-group mb-3">
										...
										<input name="password" required id="password" type="password" class="form-control" placeholder="Introduza Password Atual">
									</div>
								</div>
							</div>
